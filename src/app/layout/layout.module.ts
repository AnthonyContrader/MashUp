...
import { GuestMenuComponent } from './guest-layout/guest-menu/guest-menu.component';
 ...
 */
@NgModule({
  declarations: [AdminLayoutComponent, AdminMenuComponent, HeaderComponent, GuestLayoutComponent,GuestMenuComponent],
  imports: [
    CommonModule,
    RouterModule
  ]
